...
#region Interaction
		...
		static void SettingsIsUVC()
		{
            ...
            OrbbecManager.Instance.Param.IsUseUVC = /*curType == SensorType.ASTRA_PRO_S_TYPE ||*/ (curType == SensorType.ASTRA_PRO_TYPE || curType == SensorType.ASTRA_PRO_PLUS_TYPE || curType == SensorType.ASTRA_PRO_X_TYPE ||curType == SensorType.ASTRA_PRO_X2_TYPE);
#else
...
// 				}
...
#else
			OrbbecNativeMethods.SetResolution( ms_BufferSize.ImageXSize, ms_BufferSize.ImageYSize);
			OrbbecNativeMethods.StartUVCCamera();
#endif
		}
		...
		public void UpdateData()
		{
			try
			{
                ...
                //Log.PrintToLog(Log.Level.Log, " CopyDepth " + _watch.Elapsed.ToString());
                ...
                //Log.PrintToLog(Log.Level.Log, " CopyLabel " + _watch.Elapsed.ToString());
